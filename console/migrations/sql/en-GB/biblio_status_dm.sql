insert into {{%biblio_status_dm}} values ('in','checked in','Y');
insert into {{%biblio_status_dm}} values ('out','checked out','N');
insert into {{%biblio_status_dm}} values ('mnd','damaged/mending','N');
insert into {{%biblio_status_dm}} values ('dis','display area','N');
insert into {{%biblio_status_dm}} values ('hld','on hold','N');
