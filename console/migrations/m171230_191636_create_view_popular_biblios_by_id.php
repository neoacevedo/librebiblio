 ...
 */
class m171230_191636_create_view_popular_biblios_by_id extends Migration {
    ...
    public function safeUp() {
        if ($this->db->driverName === 'mysql') {
            $sql = "CREATE OR REPLACE VIEW {{%popular_biblios_by_id}} AS "
    ...
    public function safeDown() {
        $this->db->createCommand("drop view if exists {{%popular_biblios_by_id}}")->execute();
        return true;
    }
