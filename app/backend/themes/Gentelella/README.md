...
Usage
-----
All you need is register `backend\themes\Gentelella\assets\Asset` in your layout. This extension consists a layout example. You can find it in `backend\themes\Gentelella\views\layouts\main.php`.
