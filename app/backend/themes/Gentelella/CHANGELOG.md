...
- Enh #7: Add a an ability to add custom items to dropdown list of `backend\themes\Gentelella\widgets\Panel` (fps01)
- New #8: Added a `backend\themes\Gentelella\widgets\Timeline` widget (fps01)
...
- New #3: Added a `backend\themes\Gentelella\widgets\StatsTile` widget (fps01)
- New #2: Added a `backend\themes\Gentelella\widgets\grid\GridView` widget (fps01)
- New #4: Added a `backend\themes\Gentelella\widgets\FlashAlert` widget (fps01)
