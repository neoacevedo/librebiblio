<h1 style="align: center">
	<a href="https://www.paypal.com/donate/?hosted_button_id=BUT4UEAG3FQV8" title="PayPal - The safer, easier way to pay online!">
		<img title="PayPal - The safer, easier way to pay online!" alt="Donate with PayPal button" src="https://www.paypalobjects.com/en_US/i/btn/btn_donate_LG.gif" />
	</a>
	Yii2 Storage
</h1>
...
'components' => [
	...
	'storageLocal' => [
	    ...
	    'config' => [
	        'baseUrl' => '/web', // reemplace /web por /frontend/web o /backend/web según sea el caso.
