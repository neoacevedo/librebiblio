...
require __DIR__ . '/app/frontened/config/bootstrap.php';


$config = yii\helpers\ArrayHelper::merge(
    require __DIR__ . '/app/common/config/main.php',
    require __DIR__ . '/app/common/config/main-local.php',
    require __DIR__ . '/app/common/config/test.php',
    require __DIR__ . '/app/common/config/test-local.php',
    require __DIR__ . '/app/frontend/config/main.php',
    require __DIR__ . '/app/frontend/config/main-local.php',
    require __DIR__ . '/app/frontend/config/test.php',
    require __DIR__ . '/app/frontend/config/test-local.php'
);
