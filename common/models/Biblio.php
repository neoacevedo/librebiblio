...
class Biblio extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'call_nmbr1' => Yii::t('app', 'Call Nmbr1'),
            'call_nmbr2' => Yii::t('app', 'Call Nmbr2'),
            ...
            'topic2' => Yii::t('app', 'Topic2'),
            'topic3' => Yii::t('app', 'Topic3'),
            'topic4' => Yii::t('app', 'Topic4'),
            'topic5' => Yii::t('app', 'Topic5'),
